package ir.smartpath.authenticationservice.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${aaTest.app.jwtSecret}")
    private String jwtSecret;

    @Value("${aaTest.app.jwtExpirationMs}")
    ...
    public long getUserIDJwtToken(String token) {
